...
export default function DeleteModal ({closeModal, taskId}) {
  ...
  return (
    <div className="h-screen w-screen fixed top-0 left-0 bg-white/10 dark:bg-black/50 grid place-items-center z-10 " >
      <div className="dark:bg-neutral-800 dark:text-white rounded-md w-60 md:w-1/3 h-48 md:h-1/4 md:text-xl flex flex-col items-center justify-center gap-8 " >
